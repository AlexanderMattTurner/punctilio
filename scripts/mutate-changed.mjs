 ...
 *
 * Any extra flags after the base ref are forwarded to Stryker, e.g.
...
const [baseArg, ...strykerArgs] = process.argv.slice(2)
const baseRef = baseArg ?? firstExistingRef(["origin/main", "main"])
if (!baseRef) {
...
const result = spawnSync(
  "npx",
  ["stryker", "run", "--mutate", changed.join(","), ...strykerArgs],
